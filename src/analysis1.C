...
void analysis1(){
    TFile* outFile=new TFile("/Users/swarupdas/icloud/Documents/ToCoSiAn/data/analysis_output.root","RECREATE");
    ...
    c1->SaveAs("/Users/swarupdas/icloud/Documents/ToCoSiAn/data/Analysis_plots.pdf");
